    ...
    return (
        <div className="w-full p-1">
            <div className="flex justify-between">
                <Paragraph className="text-sm font-bold text-blue-600">{title.toLocaleUpperCase()}</Paragraph>
                <Paragraph className="text-sm font-bold text-blue-600">{progressBarWidth}%</Paragraph>
            </div>
